...
<body>
	...
	try {
		String str = "select * from AuctionCreates join ItemBelongsToSelling using (item_ID) join CategorySubCategory_1SubCategory_2SubCategory_3 using (item_ID, category_name) order by (auction_ID);";
